...
ForeignTaxWithheld | Yes  | Pct of income withheld for foreign taxes
Expense            | Yes  | Expense ratio of fund, reduces return
...
```{r, fig.show='hold'}
# across all accounts
w.ac<-t(round(100*apply(eff[,3:ncol(eff)],1,calc.ac.wts,cma.ta),1))
